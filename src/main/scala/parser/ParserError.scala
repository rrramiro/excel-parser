...
object ParserError {
  private case class InvalidFormat(ref: String, expectedFormat: String, message: String)
      extends ParserError
  ...
  def invalidFormat(ref: String, expectedFormat: String, message: String): ParserError =
    InvalidFormat(ref, expectedFormat, message)
